    ...
    return(
      ...
      <Link to='/' >
        <button >
          ...
          <span class="go">LaloDex!</span>
          <span class="pword">pika</span>
          <span to='/home' class="pword2">pika</span>
        </button>
        </Link>
      </div>
      ...
      <div className="menu Pusheen">
        <img src="/src/assets/static/dex/Pokes/img/Pusheen.png" alt="" />
      </div>
      ...
      <div className="header-right">
        <div class="social-links">
         <Link to='https://twitter.com/El_LaloInMadrid'>
          <div id="twitter" class="social-btn flex-center">
            ...
            <span className="redes">@el_LaloInMadrid</span>
          </div>
          </Link>

        <Link to='https://www.linkedin.com/in/eduardo-tellez-analyst-dev/'>
            <div id="linkedin" class="social-btn flex-center">
              ...
              <span className="redes">in/eduardo-tellez-analyst-dev</span>
            </div>
          </Link>

          <Link to='https://github.com/Lalote23'>
            <div id="github" class="social-btn flex-center">
              ...
              <span className="redes">Lalote23</span>
            </div>
          </Link>
        </div>
      </div>
        ...
        <h1 className="pokeletra">Bienvenido Entrenador...</h1>
            ...
            <div className="titulo">
                ...
                <h1 className="pokeletra"></h1>

            <div className="centrar">
            <div className="texto">

                <h2>¿Estás listo para comenzar tu aventura?</h2>

                <p>
                Bienvenido a una pokedex diferente, la LaloDex.
                <br></br> 
                <br></br> 

                Esta es una herramienta diferente, a comparación de otras pokedex aquí puedes ver los tipos de cada Pokémon y contra que tipo es fuerte y débil para crear tus estrategias. 
                <br></br> 
                <br></br>

                También puedes diseñar tu equipo, solo debes elegir el número de tus Pokémon.
                <br></br>
                Aquí puedes ver los equipos de todos los lideres Pokémon de cada región para saber que Pokémon llevar a tu pelea.
                <br></br> 
                <br></br> 

                Cuantos más descubrimientos haya en el mundo Pokémon, la información se irá actualizando. :)</p>
            </div>
            </div>
            </div>
